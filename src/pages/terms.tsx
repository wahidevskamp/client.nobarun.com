  ...
  return (
    <Box p="20px" mb="70px">
      ...
      >
        ...
        of Nobarun International's Website, located at
        <a href="https://www.nobarunbd.com/" style={{ color: '#0082c9' }}>
          www.nobarunbd.com
        </a>
        <br />
      ...
      >
        ...
        the intellectual property rights for all material on Nobarun
        ...
        <li>Sell, rent or sub-license material from Nobarun International</li>
        <li>
        ...
        were created with the help of the <u>Terms And Conditions Template.</u>
        <br />
        <br />
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Nobarun International does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of Nobarun International,its agents and/or
        ...
        laws, Nobarun International shall not be liable for the Comments or for
        ...
        <br />
        <br />
        Nobarun International reserves the right to monitor all Comments and to
      ...
      >
        ...
        the hyperlink compensates the absence of Nobarun International; and (d)
        ...
        e-mail to Nobarun International. Please include your name, your
        ...
        <br />
        No use of Nobarun International's logo or other artwork will be allowed
