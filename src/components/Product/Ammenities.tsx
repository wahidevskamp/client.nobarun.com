  ...
  return (
    <ProductCard12 title="Office Amenities">
      <ul>
        ...
        <li className="mb-10">
          <FlexBox alignItems="center">
            <Icon size="4rem">icons8-card-payment-48</Icon>
            <Typography letterSpacing="1px" ml="1.5rem" fontSize="22px">
        ...
        <li className="mb-10">
          <FlexBox alignItems="center">
            <Icon size="4rem">icons8-motorcycle-48</Icon>
            <Typography letterSpacing="1px" ml="1.5rem" fontSize="22px">
        ...
        <li className="mb-10">
          <FlexBox alignItems="center">
            <Icon size="4rem">icons8-elevator-48</Icon>
            <Typography letterSpacing="1px" ml="1.5rem" fontSize="22px">
              Lift / Elevetor
            </Typography>
          </FlexBox>
        ...
        <li className="mb-10">
          <FlexBox alignItems="center">
            <Icon size="4rem">icons8-wi-fi-connected-48</Icon>
            <Typography letterSpacing="1px" ml="1.5rem" fontSize="22px">
              Wireless Internet
            </Typography>
          </FlexBox>
